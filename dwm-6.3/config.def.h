...
// inactive win border colour
static const char col_gray2[]       = "#444444";
//font colour
static const char col_gray3[]       = "#bbbbbb";
//current tag and current win font colour
static const char col_gray4[]       = "#eeeeee";
//top bar second colour and active window border colour
static const char col_cyan[]        = "#40aec5";
...
static const char *light_up[] = {"/usr/bin/brightnessctl", "set", "+1%", NULL};
static const char *light_down[] = {"/usr/bin/brightnessctl", "set", "1%-", NULL};
